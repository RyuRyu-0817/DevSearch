            ...
            <div class="max-w-md w-full m-auto">
                ...
                <form @submit.prevent="signUp" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" id="password" v-model="userData.password1" required name="password" class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
                    </div>
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">パスワード(再)</label>
                        <input type="password" id="password" v-model="userData.password2" required name="password" class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
                    </div>
                    <div>
